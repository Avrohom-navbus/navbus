  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4"
      ...
      <div className="bg-white rounded-4xl p-10 w-full max-w-md shadow-2xl">
        ...
        <p className="text-gray-500 font-semibold text-sm mb-8">Sign in to your Navbus account</p>

        {error && (
          <div className="bg-red-50 text-red-600 rounded-2xl p-4 mb-6 text-sm font-bold">{error}</div>
        )}
