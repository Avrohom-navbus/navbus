        ...
        return (
                <div className="min-h-screen flex items-center justify-center px-4"
                          ...
                          <div className="bg-white rounded-4xl p-10 w-full max-w-md shadow-2xl text-center">
                                    ...
                                    <h2 className="text-2xl font-black mb-3">Account submitted!</h2>h2>
    ...
    return (
          <div className="min-h-screen flex items-center justify-center px-4 py-12"
                ...
                <div className="bg-white rounded-4xl p-10 w-full max-w-md shadow-2xl">
                        ...
                        <h1 className="text-2xl font-black mb-1">Join Navbus 🚌</h1>h1>
                  ...
                  {error && (
                              <div className="bg-red-50 text-red-600 rounded-2xl p-4 mb-4 text-sm font-bold">{error}</div>div>
                        )}
                
                        <form onSubmit={handleSignup} className="flex flex-col gap-4">
                                  <div>
                                              <label className="block text-sm font-extrabold mb-2">Full Name</label>label>
                                  ...
                                  <div>
                                              <label className="block text-sm font-extrabold mb-2">Email Address</label>label</div>>
                                      <input type="email" value={email} onChange={e => setEmail(e.target.value)} required
                                                      placeholder="you@email.com"
                                                      className="w-full px-4 py-3 rounded-2xl border-2 border-gray-100 font-semibold text-sm outline-none focus:border-purple-500 transition-colors" />
                        </form>div>
                            <div>
                                        <label className="block text-sm font-extrabold mb-2">Phone Number</label>label>
                  ...
                  {role === "parent" && (
                                <div>
                                              <label className="block text-sm font-extrabold mb-2">Bus Route / Company Code</label>label>
                  ...
                  <p className="text-center text-sm font-semibold text-gray-500 mt-6">
                            ...
                            <Link href="/auth/login" className="font-extrabold" style={{ color: "#7B2FBE" }}>Sign In</Link>Link>
                  </p>p>
          </div>div>
      </div>
        );
