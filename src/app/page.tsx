    ...
    <main className="min-h-screen" style={{ fontFamily: "'Nunito', sans-serif" }}>
      ...
      <nav className="bg-white sticky top-0 z-50 shadow-sm px-8 py-4 flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <span className="text-xl font-black text-gray-800">
            Nav<span style={{ color: "#F5A623" }}>bus</span>
          </span>
        </div>
        <div className="flex items-center gap-3">
      ...
      <section className="py-24 px-8 text-center relative overflow-hidden"
        ...
        <div className="relative max-w-3xl mx-auto">
          ...
          <h1 className="text-5xl font-black text-white leading-tight mb-4">
            ...
            <span style={{ color: "#FFC85A" }}>your bus is</span>, always.
          </h1>
      ...
      <div className="bg-white py-8 px-8 flex justify-center gap-16 flex-wrap shadow-sm">
        {[
          ...
          <div key={s.label} className="text-center">
            <div className="text-3xl font-black" style={{ color: "#7B2FBE" }}>{s.num}</div>
      ...
      <section className="py-20 px-8 max-w-5xl mx-auto">
        <h2 className="text-3xl font-black text-center mb-2">
          Built for <span style={{ color: "#7B2FBE" }}>everyone</span> on the route
        </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {[
            ...
            <div key={card.title} className="rounded-3xl p-8 text-white relative overflow-hidden"
              ...
              <p className="text-sm opacity-90 font-semibold leading-relaxed">{card.desc}</p>
            </div>
          ))}
        </div>
      </section>
      ...
      <section className="py-20 px-8" style={{ background: "#F3EAFD" }}>
        <div className="max-w-5xl mx-auto">
          <h2 className="text-3xl font-black text-center mb-2">
            How <span style={{ color: "#7B2FBE" }}>Navbus</span> works
          </h2>
          <p className="text-center text-gray-500 font-semibold mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
            {[
              ...
              <div key={step.n} className="bg-white rounded-2xl p-6 text-center shadow-md">
                ...
                <h4 className="font-extrabold mb-2 text-sm">{step.title}</h4>
                <p className="text-xs text-gray-500 font-semibold leading-relaxed">{step.desc}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <footer className="bg-gray-900 text-white/60 py-10 px-8 text-center">
        <div className="font-black text-white text-xl mb-2">Navbus©</div>
        <div className="text-sm font-semibold">Nav-ur-bus and they&apos;re safe with us</div>
        <div className="mt-6 text-xs">© 2024 Navbus. All rights reserved.</div>
      </footer>
    </main>
  );
}
